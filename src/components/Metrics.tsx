...
export default function Metrics({ home }: { home: Populated<HomePage> }) {
  const {
    PROJECTS_FILMED,
    VIDEOS_RENDERED,
  ...
  return (
    <section className="relative bg-black px-6 py-24 lg:py-40">
      <div className="container mx-auto max-w-300">
        <h3 className="mb-6 text-3xl font-extrabold md:mb-12 md:text-5xl">
          {home.stats.metrics_title}
        </h3>

        <ul className="grid max-w-250 grid-cols-2 items-start justify-start gap-10 md:grid-cols-[repeat(auto-fit,minmax(160px,1fr))]">

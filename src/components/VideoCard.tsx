...
export default function VideoCard({
  ...
  return (
    <motion.a
      ...
      onMouseLeave={pause}
    >
      <div className="spring-duration-700 spring-bounce-40 absolute bottom-3 left-2.5 isolate z-10 flex w-full max-w-[calc(100%-30px)] flex-col contain-inline-size group-hover:bottom-2.5 group-hover:left-3.5 lg:bottom-9 lg:left-6 lg:group-hover:bottom-6 lg:group-hover:left-6">
        ...
        <span className="text-md overflow-gradient-mask pointer-events-none line-clamp-1 flex w-full items-center overflow-clip font-semibold text-ellipsis whitespace-nowrap text-shadow-lg sm:text-xl">
          {video.title}
        </span>
      </div>

...
const collectionEntries = await getCollection("videos")
...
export const { getStaticPaths, GET } = OGImageRoute({
  ...
  getImageOptions: async (path, page: CollectionEntry<"videos">["data"]) => ({
    title: page.title,
    description: "Video by Vek Labs".toLocaleUpperCase(),
